export const navItems = [
  ...
  export const gridItems = [  
      ...
      },
      {
        ...
        className: "col-span-1 md:col-span-6 lg:col-span-6 row-span-1", // Full row
        imgClassName: "",
      ...
      },
      {
        ...
        className: "col-span-1 md:col-span-3 lg:col-span-4 row-span-1", // More space
  ...
  export const projects = [
    ...
    },
    {
      ...
      link: "https://github.com/Fideliahajdin/ai_saas_app",
    },
    {
      id: 4,
  ...
  export const testimonials = [
    {
      quote:
        "Collaborating with Fidelia was an absolute pleasure. His professionalism, promptness, and dedication to delivering exceptional results were evident throughout our project. Fidelia's enthusiasm for every facet of development truly stands out. If you're seeking to elevate your website and elevate your brand, Fidelia is the ideal partner.",
