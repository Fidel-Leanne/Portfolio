        ...
        <div className='flex flex-wrap sm:flex-wrap items-center justify-center p-4 gap-x-24 gap-y-6 mt-10'>
            {projects.map(({id,title,des,img,iconLists,link})=>(
                ...
                <PinContainer title={link} href={link}>
                  ...
                  <p className='lg:text-xl lg:fon-normal font-light text-sm line-clamp-2t'>
                    {des}
                  </p>
                  ...
                  <p className="flex lg:text-xl md:text-xs text-sm text-yellow-600">
                    Check Live Site
                  </p>
                  <FaLocationArrow className="ms-3" color="yellow" />
                </div>
                  </div>
                </PinContainer>
                </div>
